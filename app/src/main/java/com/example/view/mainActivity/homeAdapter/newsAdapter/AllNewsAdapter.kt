...
class AllNewsAdapter (var context: Context, private var  newsList:ArrayList<com.example.model.news.List>
                      , var onclick: RecyclerViewOnclick):RecyclerView.Adapter<AllNewsAdapter.viewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewHolder {
        return viewHolder(LayoutInflater.from(context).inflate(R.layout.all_news_rv,parent,false))
    }
