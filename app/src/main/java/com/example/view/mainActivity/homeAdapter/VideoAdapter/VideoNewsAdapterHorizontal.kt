package com.example.view.mainActivity.homeAdapter.VideoAdapter
...
class VideoNewsAdapterHorizontal (var context: Context, private var  videoList:ArrayList<VideoList>
                                  , var onclick: NewsVideoRecyclerViewOnclick
                                 ):RecyclerView.Adapter<VideoNewsAdapterHorizontal.viewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewHolder {
        return viewHolder(LayoutInflater.from(context).inflate(R.layout.video_news_rv_element_horizontal,parent,false))
    }
